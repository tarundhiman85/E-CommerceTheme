                   ...
                   <div class="card-body px-5">
                       ...
                       <form action="RegisterServlet" method="post">
                           ...
                           <div class="form-group">
                               ...
                               <input name="user_password" type="password" class="form-control" productId="password" placeholder="Enter Password Here" aria-describedby="emailHelp" >
                           </div>
                           <div class="form-group">
                               <%--@declare id="password"--%><label for="password">Confirm Password</label>
                                   <h6 style="    font-size: xx-small;">Password must have atleast 1 capital letter and number and small case letter</h6>
                               <input name="confirm_password" type="password" class="form-control" productId="password" placeholder="Enter Password Here" aria-describedby="emailHelp" >
                           </div>
                           <div class="form-group">
