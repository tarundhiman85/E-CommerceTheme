...
<%@ page import="mycart.Model.ContactUs" %>
...
<%--                    show list of contact us queries--%>
...
<%--Displaying list of user queries--%>
    <div class="row" style="margin-top: 10rem">
        <div class="col-4" style="margin-left: 20rem">
            <h3>User Queries</h3>
            <table>
                <tr class="top">
                    <td>Sr.No</td>
                ...
                <%
                    List<ContactUs> l = new UserDao(FactoryProvider.getFactory()).getUserContactUs();
                    for (ContactUs c:l) {
                    %>
                <div class="item1">
                    <tr class="top">
